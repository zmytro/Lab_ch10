...
public class Ex10_14_PieceWorker extends Ex10_14_Employee {
    private double wage;
    private int pieces;

    public Ex10_14_PieceWorker(String firstName, String lastName, String socialSecurityNumber, double wage, int pieces) {
